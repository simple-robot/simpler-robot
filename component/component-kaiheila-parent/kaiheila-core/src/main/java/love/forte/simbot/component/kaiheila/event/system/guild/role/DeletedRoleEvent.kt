package love.forte.simbot.component.kaiheila.event.system.guild.role
 ...
 */
@Serializable
public data class DeletedRoleEventBody(
    /**
     * 角色id
     */
    @SerialName("role_id")
 ...
 */
@Serializable
public data class DeletedRoleEventExtra(override val body: DeletedRoleEventBody) :
    GuildRoleEventExtra<DeletedRoleEventBody> {
