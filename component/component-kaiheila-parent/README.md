...
这是一个 [开黑啦平台](https://www.kaiheila.cn/) 的机器人开发框架，是对接了simple-robot(下文简称`simbot`)标准API的通用开发框架。
...
- [核心模块 component-kaiheila-core](component-kaiheila-core)
  
  核心模块提供针对于 [开黑啦开发者平台](https://developer.kaiheila.cn/doc) 以及 [simbot-标准API模块](../../core-parent/api) 进行封装，提供一套实现了simbot-api的标准开黑啦标准库。
