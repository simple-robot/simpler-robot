...
internal class CoreBootEntranceContextImpl(
    ...
    override fun getListenerManager(beanContainer: BeanContainer): EventListenerManager {
        ...
        val componentRegistryConfigures: List<ComponentRegistryConfigure> =
            beanContainer.allInstance<ComponentRegistryConfigure>()
                .ifEmpty { listOf(InstallAllComponentRegistryConfigure) }
