...
import love.forte.simboot.autoconfigure.application.SpringBootApplication
...
public open class SimbotSpringBootApplicationConfiguration {
    ...
    public fun applicationConfiguration(): SpringBootApplicationConfiguration {
        return SpringBootApplicationConfiguration()
    }
    ...
    public fun simbotSpringBootApplication(
        ...
        applicationConfigures: List<SimbotSpringBootApplicationConfigure>,
