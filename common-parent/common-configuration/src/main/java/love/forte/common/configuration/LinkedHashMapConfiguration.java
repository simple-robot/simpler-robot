...
/**
 *
 * 基于 LinkedHashMap的 {@link Configuration} 基础实现类
 *
 * @author <a href="https://github.com/ForteScarlet"> ForteScarlet </a>
 */
public class LinkedHashMapConfiguration extends LinkedHashMap<String, ConfigurationProperty> implements Configuration {

    public LinkedHashMapConfiguration(int initialCapacity, float loadFactor) {
        super(initialCapacity, loadFactor);
    }
    public LinkedHashMapConfiguration(int initialCapacity) {
        super(initialCapacity);
    }
    public LinkedHashMapConfiguration() {
    }
    public LinkedHashMapConfiguration(Map<? extends String, ? extends ConfigurationProperty> m) {
        super(m);
    }
    public LinkedHashMapConfiguration(int initialCapacity, float loadFactor, boolean accessOrder) {
