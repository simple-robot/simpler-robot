...
public interface ConfigurationInjector {
     ...
     */
    <T> T inject(T configInstance, Configuration configuration, ConverterManager converterManager);
     ...
     * @throws love.forte.common.configuration.exception.ConfigurationInjectException 如果注入的时候出现意外，则可能抛出此异常。
     */
    default <T> T inject(T configInstance, Configuration configuration) {
        return inject(configInstance, configuration, null);
    }
}
