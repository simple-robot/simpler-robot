 ...
 * 定义可以得到原始数据的字符串信息。
 */
@_root_ide_package_.love.forte.common.annotations.ContainerType("原始数据容器")
 ...
 * 一般代表这个人在群里的权限
 */
@_root_ide_package_.love.forte.common.annotations.ContainerType("权限容器")
 ...
 * 标识容器。定义可以得到一个标识。
 */
@_root_ide_package_.love.forte.common.annotations.ContainerType("标识容器")
 ...
 */
@_root_ide_package_.love.forte.common.annotations.ContainerType("行动动机容器")
