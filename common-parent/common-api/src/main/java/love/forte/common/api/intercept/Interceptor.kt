package love.forte.common.api.intercept

import love.forte.common.constant.PriorityConstant
...
interface Interceptor<T, C: Context<T>> : Comparable<Interceptor<*, *>> {
     ...
     */
    @JvmDefault
    val priority: Int get() = _root_ide_package_.love.forte.common.constant.PriorityConstant.CORE_LAST
