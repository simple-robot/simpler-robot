 ...
 * 群号容器。定义可以得到一个群的群号
 */
@_root_ide_package_.love.forte.common.annotations.ContainerType("群号容器")
 ...
 * 头像不是必须的，可能会不存在
 */
@_root_ide_package_.love.forte.common.annotations.ContainerType("群头像容器")
 ...
 */
@_root_ide_package_.love.forte.common.annotations.ContainerType("群信息容器")
public interface GroupInfo : GroupAvatarContainer, GroupCodeContainer, GroupNameContainer

/**
 * 可以得到一个[群信息][GroupInfo]容器
 */
@_root_ide_package_.love.forte.common.annotations.ContainerType("群容器")
