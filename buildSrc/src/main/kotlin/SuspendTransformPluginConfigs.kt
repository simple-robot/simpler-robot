    ...
    transformers {
        fun TransformerSpec.excludeTransMarks() {
            addCopyAnnotationExclude {
                ...
                className.set(SuspendTransformPlugins.SUSPEND_TRANS_ANNO_NAME)
            }
            addCopyAnnotationExclude {
                packageName.set(SuspendTransformPlugins.SUSPEND_RUNNER_PACKAGE)
                className.set(SuspendTransformPlugins.SUSPEND_TRANS_PROPERTY_ANNO_NAME)
            }
        }
        ...
        fun TransformerSpec.includeApi4J(clear: Boolean = true, blocking: Boolean = false) {
            ...
            addSyntheticFunctionIncludeAnnotation {
                classInfo {
                    ...
                    className.set(SuspendTransformPlugins.API4J_NAME)
                }
        ...
        fun TransformerSpec.blockingFunction() {
            transformFunctionInfo {
                packageName.set(SuspendTransformPlugins.SUSPEND_RUNNER_PACKAGE)
                functionName.set(SuspendTransformPlugins.RUN_IN_BLOCKING_FUN_NAME)
            }
        }
        ...
        fun TransformerSpec.asyncFunction() {
            transformFunctionInfo {
                packageName.set(SuspendTransformPlugins.SUSPEND_RUNNER_PACKAGE)
                functionName.set(SuspendTransformPlugins.RUN_IN_ASYNC_FUN_NAME)
            }
        }
