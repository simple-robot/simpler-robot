    ...
    private suspend fun sendByInteractionMessage(message: InteractionMessage): QGMessageReceipt {
        return when (message) {
            ...
            is InteractionMessage.Message -> {
                val builder = MessageParsers.parse(bot, MessageDestination.DMS, message.message)
                send0(builder)
            }
            ...
            is InteractionMessage.MessageContent -> {
                ...
                val builder = MessageParsers.parse(bot, MessageDestination.DMS, messageContent.messages)
                send0(builder)
            }
