 ...
 * 将当前时间戳实例转化为 [Instant].
 */
public inline val Timestamp.instantValue: Instant get() = takeIf { it is InstantTimestamp }?.let { (it as InstantTimestamp).instant } ?: Instant.ofEpochMilli(millisecond)
