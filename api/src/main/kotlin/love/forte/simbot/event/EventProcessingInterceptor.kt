 ...
 */
public interface EventProcessingInterceptor : Interceptor<EventProcessingInterceptor.Context, EventProcessingResult> {
    override suspend fun intercept(context: Context): EventProcessingResult

    /**
     * [EventProcessingInterceptor] 的传递上下文。
     */
    public interface Context : Interceptor.Context<EventProcessingResult> {
 ...
 * 事件监听函数拦截器，
 */
public interface EventListenerInterceptor : Interceptor<EventListenerInterceptor.Context, EventResult> {
    override suspend fun intercept(context: Context): EventResult

    /**
     * [EventListenerInterceptor] 的传递上下文。
     */
    public interface Context : Interceptor.Context<EventResult> {
