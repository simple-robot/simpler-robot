...
import love.forte.simbot.spring2.configuration.listener.KFunctionEventListenerProcessor
...
@SpringBootTest(
    classes = [
        FindRepeatableFilterV2Tests.TestHd::class,
        DefaultBinderManagerProvidersConfiguration::class,
    ]
)
@SpringBootConfiguration
open class FindRepeatableFilterV2Tests {
