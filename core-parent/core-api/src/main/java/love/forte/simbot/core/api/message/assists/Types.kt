...
package love.forte.simbot.core.api.message.assists
 ...
 * ### 行动动机
 *
 * **行动动机** 类型, 一般不同的消息事件中可能会有其各自独特的 **类型** 枚举,
 * 例如
 * - [群消息类型][love.forte.simbot.core.api.message.events.GroupMsg.Type] ,
 * - [增加类型][love.forte.simbot.core.api.message.events.PrivateMsg.Type]
 * 等。
 *
 * ### 动机表达
 *
